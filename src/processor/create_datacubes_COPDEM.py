...
# dc_locations_table_path = '/home/eouser/datacubes/ARCEMECUBES/clean_code/sample_locations_marcin.csv' #'/home/eouser/datacubes/DATA_ARCEME/dhp_global_subselection_mod_MK.csv'
dc_locations_table_path =  '/home/eouser/datacubes/arceme-datacubes/arceme-datacubes/datasets/dhp_global_subselection_new_melanie.csv'#'/home/eouser/datacubes/arceme-datacubes/arceme-datacubes/datasets/1_max_precipitation_grid_cells.csv'
table = pd.read_csv(dc_locations_table_path)
nrow = table.shape[0]
base_output_dir = '/ARCEMECUBES/NEW-CUBES-MELANIE/COPDEM/' #'/ARCEMECUBES/PRODUCTION_CUBES/CLOUDFERRO/COPDEM/'
